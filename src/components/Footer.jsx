...
export default function Footer({ onOpenResume }) {
  ...
  return (
    <footer className="bg-theme-bg border-t border-theme-border pt-16 pb-12 transition-colors duration-300 relative z-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-12">
          ...
          <div className="space-y-4 text-left">
            ...
            >
              ...
              <span className="font-extrabold text-lg text-theme-text tracking-wider font-mono bg-gradient-to-r from-brand-cyan to-brand-purple bg-clip-text text-transparent group-hover:opacity-85 transition-opacity">
                YAM
              </span>
            </div>
            
            <div className="space-y-1">
              <h4 className="text-sm font-bold text-theme-text">{name}</h4>
          ...
          <div className="space-y-4 text-left">
            <h4 className="text-xs font-bold uppercase tracking-wider text-theme-muted font-mono">
              Quick Links
            </h4>
            <div className="grid grid-cols-2 gap-x-4 gap-y-2.5">
              {navItems.map((item) => (
                <button
                  ...
                  className="text-[13px] text-left text-theme-muted hover:text-brand-purple dark:hover:text-brand-cyan hover:translate-x-1 transition-all duration-250 cursor-pointer font-medium"
                >
                  {item.label}
                </button>
              ))}
          ...
          <div className="space-y-4 text-left">
            ...
            <div className="space-y-4 text-[13px] text-theme-muted">
              <a 
                href={`mailto:${email}`} 
              ...
              <div className="flex items-center justify-between gap-4 flex-wrap">
                ...
                <div className="flex items-center space-x-2">
                  <a 
                    ...
                    className="p-2.5 rounded-xl bg-theme-bg hover:bg-theme-sec dark:bg-theme-bg dark:hover:bg-theme-sec text-theme-muted hover:text-brand-cyan hover:shadow-[0_0_10px_rgba(6,182,212,0.25)] transition-all"
                    aria-label="GitHub"
                  >
                    <FaGithub size={16} />
                  </a>
                  <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="p-2.5 rounded-xl bg-theme-bg hover:bg-theme-sec dark:bg-theme-bg dark:hover:bg-theme-sec text-theme-muted hover:text-brand-purple hover:shadow-[0_0_10px_rgba(168,85,247,0.25)] transition-all"
                    aria-label="LinkedIn"
                  >
                    <FaLinkedin size={16} />
                  </a>
                  <a 
                    href={`mailto:${email}`}
                    className="p-2.5 rounded-xl bg-theme-bg hover:bg-theme-sec dark:bg-theme-bg dark:hover:bg-theme-sec text-theme-muted hover:text-brand-pink hover:shadow-[0_0_10px_rgba(236,72,153,0.25)] transition-all"
                    aria-label="Email"
                  >
                    <Mail size={16} />
                  </a>
                ...
                <button
                  ...
                  className="inline-flex items-center space-x-1 px-3 py-2 rounded-xl bg-theme-bg/80 hover:bg-theme-sec dark:bg-theme-bg dark:hover:bg-theme-sec text-theme-muted hover:text-brand-cyan hover:scale-105 transition-all duration-200 border border-theme-border cursor-pointer text-xs font-semibold"
                >
                  <ChevronUp size={14} />
                  <span>Top</span>
                </button>
        ...
        <div className="pt-8 border-t border-theme-border">
          <div className="flex flex-wrap justify-center gap-x-6 gap-y-2 text-[11px] text-theme-muted font-mono font-medium">
        ...
        <div className="pt-8 border-t border-theme-border flex flex-col md:flex-row items-center justify-between text-xs text-theme-muted gap-6">
          <p className="font-semibold font-mono text-center md:text-left">
            © 2026 Yash Anil Mahajan. All Rights Reserved.
          </p>

          {/* Visitor Counter badge */}
          <div className="flex items-center space-x-1.5 px-3 py-1.5 rounded-full bg-theme-bg border border-theme-border font-mono">
            <Eye size={12} className="text-brand-cyan" />
            <span className="text-[10px] text-theme-muted font-bold uppercase tracking-wider">Visitor:</span>
